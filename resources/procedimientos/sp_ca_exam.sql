...
IS
  ...
  BEGIN
    ...
    IF V_EN_ID = 0 THEN
      ...
      V_G := CREAR_EXAM(V_EN_ID,V_EN_FECHA,V_EN_PUBLICADO,V_EN_SUBAREA_ID,V_EN_TITULO);
    ...
    ELSE --SI SE DIJITA POR EL USUARIO
        ...
        ELSE --SI ENCONTRO REGISTRO ENTONCES LA ACTUALIZA
            ...
            V_G := ACTUALIZAR_EXAM(V_EN_ID,V_EN_FECHA,V_EN_PUBLICADO,V_EN_SUBAREA_ID,V_EN_TITULO);
